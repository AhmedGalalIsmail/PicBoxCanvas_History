...
Next step: consolidate per-file diagrams into a single overall system diagram and produce a short "README for contributors" that points to these docs. Shall I proceed with consolidation now?